# Templates
Corresponde a un repositorio en el cual hay una serie de templates para documentos de todo estilo en LaTex. 
Por ahora y para siempre correspondera a un repositorio en crecimiento y actualización, de modo que se esperan cambios constamtes.
Por ahora hay tres templates principales cada uno en una carpeta:
